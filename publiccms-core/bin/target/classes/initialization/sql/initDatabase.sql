...
CREATE TABLE `cms_content` (
  ...
  `disabled` tinyint(1) NOT NULL COMMENT '是否删除',
  `label` varchar(50) DEFAULT '' COMMENT '图片标签',
  `keywords` varchar(50) DEFAULT '' COMMENT '关键词',
  `top` int(1) NOT NULL default '0' COMMENT '头条',
  PRIMARY KEY  (`id`),
...
INSERT INTO `sys_moudle` VALUES ('119', '还原', NULL, 'cmsContent/recycle', NULL, '117', '1', '0');
...
INSERT INTO `sys_moudle` VALUES ('1001', '留言管理', 'cmsMessage/list', null, '<i class="icon-comments-alt icon-large"></i>', '109', '1', '0');
INSERT INTO `sys_moudle` VALUES ('1004', '文件管理', 'cmsPartner/list', null, '<i class="icon-folder-open-alt icon-large"></i>', '109', '1', '0');
INSERT INTO `sys_moudle` VALUES ('1003', '删除', null, 'cmsMessage/delete', null, '1001', '1', '0');
INSERT INTO `sys_moudle` VALUES ('1005', '增加/修改', 'cmsPartner/add', 'cmsPartner/addMore,cmsPartner/lookup,cmsPartner/categoryPath,cmsPartner/contentPath,file/doUpload,cmsPartner/save', null, '1004', '1', '0');
INSERT INTO `sys_moudle` VALUES ('1006', '删除', null, 'cmsPartner/delete', null, '1004', '1', '0');
INSERT INTO `sys_moudle` VALUES ('1007', '生成', 'cmsPartner/publishParameters', 'cmsPartner/publish', null, '1004', '1', '0');
INSERT INTO `sys_moudle` VALUES ('1008', '移动', 'cmsPartner/moveParameters', 'cmsPartner/move,cmsPartner/lookup', null, '1004', '1', '0');
INSERT INTO `sys_moudle` VALUES ('1009', '推荐', 'cmsPartner/push_page', 'cmsPartner/push_page_list,cmsPartner/placeDataAdd,cmsPartner/save', null, '1004', '1', '0');
INSERT INTO `sys_moudle` VALUES ('1010', '友情链接', 'cmsLink/list', null, '<i class="icon-link icon-large"></i>', '109', '1', '0');
INSERT INTO `sys_moudle` VALUES ('1011', '增加/修改', 'cmsLink/add', 'cmsLinkr/addMore,cmsLink/lookup,cmsLink/categoryPath,cmsLink/contentPath,file/doUpload,cmsLink/save', null, '1010', '1', '0');
INSERT INTO `sys_moudle` VALUES ('1012', '删除', null, 'cmsLink/delete', null, '1010', '1', '0');
INSERT INTO `sys_moudle` VALUES ('1013', '生成', 'cmsLink/publishParameters', 'cmsLink/publish', null, '1010', '1', '0');
INSERT INTO `sys_moudle` VALUES ('1014', '移动', 'cmsLink/moveParameters', 'cmsLink/move,cmsLink/lookup', null, '1010', '1', '0');
INSERT INTO `sys_moudle` VALUES ('1015', '推荐', 'cmsLink/push_page', 'cmsLink/push_page_list,cmsLink/placeDataAdd,cmsLink/save', null, '1010', '1', '0');
INSERT INTO `sys_moudle` VALUES ('1016', '站点管理', 'cmsWebsite/list', null, '<i class="icon-map-marker icon-large"></i>', '109', '1', '0');
INSERT INTO `sys_moudle` VALUES ('122', '数据字典管理', 'cmsDictionary/list', null, '<i class=\"icon-book icon-large\"></i>', '62', '1', '0');
INSERT INTO `sys_moudle` VALUES ('123', '添加', 'cmsDictionary/add', 'cmsDictionary/save', null, '122', '0', '0');
INSERT INTO `sys_moudle` VALUES ('124', '删除', null, 'cmsDictionary/delete', null, '122', '0', '0');
...
-- Records of sys_site
-- ----------------------------
INSERT INTO `sys_site` VALUES ('1', 'CMS', '1', '/a/', '0', '/', '0');
...
-- Records of sys_task
-- ----------------------------
INSERT INTO `sys_task` VALUES ('1', '1', '重新生成首页', '0', '0 0/2 * * ?', '重新生成首页', '/publishPage.task', NULL);
...
CREATE TABLE `cms_message` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `q1` varchar(50) DEFAULT NULL COMMENT '问题一',
  `q2` varchar(50) DEFAULT NULL COMMENT '问题二',
  `q3` varchar(50) DEFAULT NULL COMMENT '问题三',
  `station` varchar(50) DEFAULT '0' COMMENT '站点',
  PRIMARY KEY (`id`)
...
CREATE TABLE `cms_partner` (
  ...
  `pretitle` varchar(255) DEFAULT NULL COMMENT '内容一',
  `subtitle` varchar(255) DEFAULT NULL COMMENT '内容二',
  `code` varchar(50) DEFAULT NULL COMMENT '模块',
  `image` varchar(255) DEFAULT NULL COMMENT '图片',
  `label` varchar(50) DEFAULT NULL COMMENT '标签',
  `url` varchar(50) DEFAULT NULL COMMENT '友情链接',
  `weight` int(50) DEFAULT '0' COMMENT '排序',
  `cut` varchar(50) DEFAULT NULL COMMENT '编码',
...
CREATE TABLE `cms_link` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(50) DEFAULT NULL COMMENT '合作单位',
  `code` varchar(50) DEFAULT NULL COMMENT '编码',
  `image` varchar(255) DEFAULT NULL COMMENT '图片',
  `label` varchar(50) DEFAULT NULL COMMENT '标签',
  `url` varchar(50) DEFAULT NULL COMMENT '友情链接',
...
-- ----------------------------
INSERT INTO `cms_website` VALUES ('1', 'xxx网站', 'home', 'xxx', 'xxx');
