 ...
 */
@Component
public class PublishMobileCategoryDirective extends AbstractTaskDirective {
    ...
    private boolean deal(SysSite site, CmsCategory entity, Integer pageIndex, Integer totalPage) {
        if (null != entity) {
            return templateComponent.createCategoryMobileFile(site, entity, pageIndex, totalPage);
        }
        return false;
    }
